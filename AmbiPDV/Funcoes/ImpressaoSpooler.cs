    ...
    internal class PrintSANSUP
    {
        ...
        private bool IMPRIME_SPOOLER()
        {
            try
            {
                ...
                if (reimpressao)
                {
                    RecebePrint(">>>>>>> REIMPRESSÃO <<<<<<<", titulo, centro, 1); RecebePrint(new string('-', 81), negrito, centro, 1);
...
#pragma warning restore CS0649
        ...
        private bool IMPRIME_SPOOLER(DateTime dtmFechado, FDBDataSetVenda.TB_FORMA_PAGTO_NFCEDataTable METODOS_DT, int intIdCaixa, bool blnFazerFechamento = true, bool relatorioX = false)
        {
            ...
            FDBDataSetVenda.TRI_PDV_OPERDataTable ResultadoTurnosAnteriores = new FDBDataSetVenda.TRI_PDV_OPERDataTable();
            ...
            List<(string COD_CFE, decimal VALOR, int ID_FMANFCE, string DESCRICAO)> valoresOperacionais = new();
            using (var SomaValoresFmapagto = new SomaValoresFmapagtoTableAdapter())
            {
