        ...
        private void PerguntaSenha_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter && txb_Senha.Password.Length > 0)
            {
                ...
                else
                {
                    ...
                    Debug.WriteLine(String.Format("Usuário {0} tentou acessar funções de técnico. Método: {1}", operador.DESCRICAO, System.Reflection.MethodBase.GetCurrentMethod().Name));
                }
            }
